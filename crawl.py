...
categorynum=int(sys.argv[1])

html = urlopen("https://news.naver.com/main/ranking/popularDay.nhn?rankingType=popular_day&sectionId="+str(99+categorynum)+"&date="+str(sys.argv[2]))  
